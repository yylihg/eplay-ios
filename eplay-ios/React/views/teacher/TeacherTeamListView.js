...
export default class TeacherTeamListView extends Component {
    ...
    _getList = function (page) {
        var url = "/answerCourse/list.do?start="+page*10+"&pageSize=10&userId=" + this.props.id;
        var context = this;
    ...
    _onItemPress(item) {
        ReactModule.pushReactViewController(findNodeHandle(this), "TeamDetailPage", item);
    }
