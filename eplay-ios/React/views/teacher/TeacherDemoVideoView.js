...
class TeacherDemoVideoView extends Component {
    ...
    _getVideoList = function (page) {
        var context = this;
        ReactModule.fetch("get",{api:"/freeVideo/list.do?start="+page*10+"&pageSize=10"+ '&teacherUserId='+this.props.id},function (error, response) {
            console.log('ihg TeacherDemoVideoView /freeVideo/list.do: ' + page, response)
            if (error){
                currentPage -=1;
            }else {
...
export default TeacherDemoVideoView;